    ...
    <div className="relative">
      ...
      >
        <div>
          ...
          <span className="mt-0.5 block text-theme-xs text-primary-500 dark:text-primary-400 capitalize">
            {user?.role || 'admin'}
          </span>
        </div>
        ...
        <button
          ...
          disabled={false}
          className="flex items-center gap-3 px-3 py-2 mt-3 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300 w-full text-left disabled:opacity-50"
        >
          <svg
